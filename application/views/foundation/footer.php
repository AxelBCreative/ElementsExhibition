  <footer>
	<section class="row">
			<span class="six columns hide-for-small">
				<a href="<?php echo base_url(); ?>">Home</a> | <a href="<?php echo base_url();?>privacy">Privacy Policy</a> | <a href="<?php echo base_url();?>sitemap.xml">Sitemap</a> | <a href="<?php echo base_url();?>admin">Admin</a>
				&nbsp;
				<span class="social social-footer">
					<a href="https://plus.google.com/111853846959134453166" target="_blank" rel="publisher"><img src="<?php echo base_url();?>assets/images/foundation/gplus.png" alt="Google+" title="The Elements Exhibition on Google Plus" /></a>				
